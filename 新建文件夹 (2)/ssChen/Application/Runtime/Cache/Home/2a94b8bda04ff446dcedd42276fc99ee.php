...
<div class="login">
	...
	<div class="login-top">
		...
		<form action="/ssChen/index.php/Home/Index/loginpro" method="post">
			<input type="text" name="account" value="User Id" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'User Id';}">
...
<div class="copyright">
	<p>By &nbsp;ssChen<a href="<?php echo U('Login/login');?>">(管理员登陆)</a></p>
</div>
